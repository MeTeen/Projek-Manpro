...
// Endpoint untuk cek apakah email customer sudah didaftarkan
router.post('/check-email', authController.checkEmailTerdaftar);

// Endpoint signup customer (buat password pertama kali)
