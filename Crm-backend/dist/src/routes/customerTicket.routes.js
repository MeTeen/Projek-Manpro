...
router.get('/tickets/stats', customerTicket_controller_1.getCustomerTicketStats);
router.get('/purchases', customerTicket_controller_1.getCustomerPurchases);
router.get('/tickets', customerTicket_controller_1.getCustomerTickets);
router.get('/tickets/:id', customerTicket_controller_1.getCustomerTicketById);
router.post('/tickets', customerTicket_controller_1.createCustomerTicket);
